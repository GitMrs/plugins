...
if (isIE678 && !isIE11) {
    ...
    if (lang == 'zh-cn') {
        info = '<p>您正在使用 Internet Explorer ' + versionNumber + ' 浏览网页，建议使用支持<span style="color: #2898E0;font-weight:bold;">HTML5</span>的高级浏览器，以便正常浏览<span style="color: #2898E0;font-weight:bold;">Qunee [DSG] for HTML5</span> 在线演示</p>';
    } else {
